...
class Advisor(BOBase):
    ...
    def get_suggorate(self, history_container=None):
    ...
    def evaluate(self, budget_left=None):

        self.config_space = self.selector.knob_selection()  ###change self.config_space
        ...
        def iterate(self, budget_left=None):
            ...
            config, trial_state, constraints, objs = self.evaluate(budget_left)
            return config, trial_state, constraints, objs
